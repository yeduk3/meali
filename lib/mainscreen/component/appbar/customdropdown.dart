// Search [Changed] to see which is changed
...
// [Changed] it makes menu's padding
const EdgeInsets _kMenuItemPadding = EdgeInsets.symmetric(horizontal: 20.0);
...
class _DropdownButtonState<T> extends State<DropdownButton<T>>
  ...
  void _handleTap() {
    ...
    _dropdownRoute = _DropdownRoute<T>(
      ...
      // [Changed] it makes menu's button size to fit
      buttonRect: itemRect,
      padding: _kMenuItemPadding.resolve(textDirection),
      // selectedIndex: _selectedIndex ?? 0,
      // [Changed] it makes start position to 0
      selectedIndex: 0,
